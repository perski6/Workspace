...
public class Enemy {
        ...
        private boolean CheckpointReached(){
            ...
            //check if enemy reached tile within variance of 3
                if( x > t.getX() - 3 &&
                    x < t.getX() + 3 &&
                    y > t.getY() - 3 &&
                    y < t.getY() + 3    ){
        ...
        private  Checkpoint FindNextC(Tile s, int[] dir){
            ...
            while (!found){
                ...
                if(s.getType() != grid.GetTile(s.getXPlace() + dir[0] * counter, s.getYPlace() + dir[1] * counter).getType()){
                    found = true;
                    //Move 1 tile back before next Tile type to seek further path
                    counter -= 1;
                    next = grid.GetTile((s.getXPlace() + dir[0] * counter), s.getXPlace() + dir[1] * counter);
                }
                counter ++;
            }
